(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function t(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=t(a);fetch(a.href,i)}})();let H="",I=null,k={};function G(e,s){I=s,k=e,window.addEventListener("hashchange",q),q()}function L(e){e!==H&&(window.location.hash=e)}function q(){const e=window.location.hash.slice(1)||"home",[s,...t]=e.split("/"),n={};t.length>0&&(n.id=t.join("/")),H=e,I&&I(s,n);let a;k[s]?a=k[s]:k["chapter/:id"]&&s==="chapter"&&(a=k["chapter/:id"]),a?a(n):(console.warn(`Route not found: ${e}`),L("home"))}const D="nypd_theme";function Y(){const e=localStorage.getItem(D),s=window.matchMedia("(prefers-color-scheme: dark)").matches;(e==="dark"||!e&&s)&&document.documentElement.classList.add("dark");const t=document.getElementById("theme-toggle");t&&t.addEventListener("click",U)}function U(){const e=document.documentElement.classList.toggle("dark");localStorage.setItem(D,e?"dark":"light")}const _="nypd_font_scale",j=.8,B=1.4,N=.1;function K(){const e=localStorage.getItem(_);let s=e?parseFloat(e):1;s=Math.max(j,Math.min(B,s)),z(s);const t=document.getElementById("font-decrease"),n=document.getElementById("font-increase");t&&t.addEventListener("click",()=>P(-N)),n&&n.addEventListener("click",()=>P(N))}function z(e){document.documentElement.style.setProperty("--font-scale",e.toString()),localStorage.setItem(_,e.toString())}function P(e){const s=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--font-scale"))||1,t=Math.max(j,Math.min(B,s+e));z(t)}const O="nypd_progress";function x(){const e=localStorage.getItem(O);if(e)try{return JSON.parse(e)}catch{}return{chapters:[],streak:0,totalStudyTimeSeconds:0}}function J(e){localStorage.setItem(O,JSON.stringify(e))}function V(e){return x().chapters.find(t=>t.chapterId===e)}function X(e){const s=x();let t=s.chapters.find(n=>n.chapterId===e);t?(t.status="completed",t.completedAt=new Date().toISOString()):(t={chapterId:e,status:"completed",questionsAnswered:0,timeSpentSeconds:0,completedAt:new Date().toISOString()},s.chapters.push(t)),J(s)}function Z(){return x().streak}function ee(){return x().totalStudyTimeSeconds}function te(){return x().chapters.filter(s=>s.status==="completed").length}function se(e){ae(e),ne(),ie()}function ae(e){const s=document.getElementById("nav-chapters");if(!s)return;const t=`
...
`),t=[];let n=!1,a=[],i=!1,l=[],r=!1,v=1;function u(){if(a.length>0){const S=a.some(c=>c.includes("|---")),o=c=>c.includes("|---"),f=a.filter(c=>!o(c));if(f.length>0){let c='<table class="cheatsheet-table">';if(S&&f.length>1){const h=f[0].split("|").filter(p=>p.trim()).map(p=>`<th>${m(p.trim())}</th>`).join("");c+=`<thead><tr>${h}</tr></thead><tbody>`;for(let p=1;p<f.length;p++){const $=f[p].split("|").filter(T=>T.trim()).map(T=>`<td>${m(T.trim())}</td>`).join("");c+=`<tr>${$}</tr>`}c+="</tbody></table>"}else{for(const h of f){const p=h.split("|").filter($=>$.trim()).map($=>`<td>${m($.trim())}</td>`).join("");c+=`<tr>${p}</tr>`}c+="</table>"}t.push(c)}}a=[],n=!1}function d(){l.length>0&&(r?t.push(`<ol class="cheatsheet-list" start="${v}">${l.join("")}</ol>`):t.push(`<ul class="cheatsheet-list">${l.join("")}</ul>`)),l=[],i=!1,r=!1,v=1}for(const S of s){const o=S.trim();if(o===""){u(),d();continue}if(o.startsWith("|")&&o.endsWith("|")){n||(d(),n=!0),a.push(o);continue}if(o.startsWith("- ")||o.startsWith("* ")){u(),(!i||r)&&(d(),i=!0,r=!1),l.push(`<li class="cheatsheet-list-item">${m(o.slice(2))}</li>`);continue}const f=o.match(/^(\d+)\.\s+(.+)$/);if(f){u(),(!i||!r)&&(d(),i=!0,r=!0,v=parseInt(f[1],10)),l.push(`<li class="cheatsheet-list-item">${m(f[2])}</li>`);continue}if(o.startsWith(">")){u(),d();const g=o.slice(1).trim();if(g.includes("**Exam Alert")){const y=g.replace(/\*\*Exam Alert[^*]*\*\*/g,"");t.push(`<div class="callout callout-exam"><div class="callout-title">Exam Alert</div><p>${m(y)}</p></div>`)}else if(g.includes("**Memory Aid")){const y=g.replace(/\*\*Memory Aid[^*]*\*\*/g,"");t.push(`<div class="callout callout-memory"><div class="callout-title">Memory Aid</div><p>${m(y)}</p></div>`)}else if(g.includes("**Prior Test")){const y=g.replace(/\*\*Prior Test[^*]*\*\*/g,"");t.push(`<div class="callout callout-prior"><div class="callout-title">Prior Test</div><p>${m(y)}</p></div>`)}else if(g.includes("**PG Conflict")){const y=g.replace(/\*\*PG Conflict[^*]*\*\*/g,"");t.push(`<div class="callout callout-conflict"><div class="callout-title">PG Conflict</div><p>${m(y)}</p></div>`)}else if(g.includes("**See Also")){const y=g.replace(/\*\*See Also[^*]*\*\*/g,"");t.push(`<div class="callout callout-seealso"><div class="callout-title">See Also</div><p>${m(y)}</p></div>`)}else if(g.includes("**Sergeant Focus")){const y=g.replace(/\*\*Sergeant Focus[^*]*\*\*/g,"");t.push(`<div class="callout callout-sergeant"><div class="callout-title">Sergeant Focus</div><p>${m(y)}</p></div>`)}else if(g.includes("**NOTE:**")){const y=g.replace(/\*\*NOTE:\*\*/g,"");t.push(`<div class="callout callout-note"><div class="callout-title">Note</div><p>${m(y)}</p></div>`)}else if(g.startsWith("**Memory Aid")){const y=g.replace(/\*\*[^*]+\*\*/g,Q=>`<strong>${Q.replace(/\*\*/g,"")}</strong>`);t.push(`<div class="callout callout-memory"><div class="callout-title">Memory Aid</div><p>${m(y)}</p></div>`)}else t.push(`<blockquote class="cheatsheet-blockquote">${m(g)}</blockquote>`);continue}if(o==="---"||o==="***"||o==="___"){u(),d();continue}const c=o.match(/^# (.+)$/),h=o.match(/^## (.+)$/),p=o.match(/^### (.+)$/),$=o.match(/^#### (.+)$/),T=o.match(/^##### (.+)$/),C=o.match(/^###### (.+)$/);if(c){u(),d(),t.push(`<h1 class="cheatsheet-h1">${m(c[1])}</h1>`);continue}if(h){u(),d(),t.push(`<h2 class="cheatsheet-h2">${m(h[1])}</h2>`);continue}if(p){u(),d(),t.push(`<h3 class="cheatsheet-h3">${m(p[1])}</h3>`);continue}if($){u(),d(),t.push(`<h4 class="cheatsheet-h4">${m($[1])}</h4>`);continue}if(T||C){u(),d(),t.push(`<p class="cheatsheet-paragraph"><strong>${m(T?T[1]:C[1])}</strong></p>`);continue}u(),d(),t.push(`<p class="cheatsheet-paragraph">${m(o)}</p>`)}return u(),d(),t.join("")}function m(e){if(!e)return"";let s=e;return s=s.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),s=s.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),s=s.replace(/\*([^*]+)\*/g,"<em>$1</em>"),s=s.replace(/`([^`]+)`/g,"<code>$1</code>"),s}let w="study";function R(e){const s=e==null?void 0:e.id;if(!s||!E.data){window.location.hash="home";return}const t=E.data.chapters.find(i=>i.id===s);if(!t){window.location.hash="home";return}A([{label:"Home",route:"home"},{label:`${t.sectionNum} — ${t.title}`}]);const n=document.getElementById("content");if(!n)return;n.innerHTML=`
  ...
  `}function ue(){A([{label:"Home",route:"home"},{label:"Quick Quiz"}]);const e=document.getElementById("content");e&&(e.innerHTML=`
    <h1>Quick Quiz</h1>
    <p>10 random questions for fast practice drill.</p>
    <div id="quiz-container">
      <p>Quiz functionality coming soon...</p>
    </div>
  `)}function he(){A([{label:"Home",route:"home"},{label:"Practice Exam"}]);const e=document.getElementById("content");e&&(e.innerHTML=`
    <h1>Practice Exam</h1>
    <p>Full 140-question timed exam simulating test conditions.</p>
    <div id="exam-container">
      <p>Exam functionality coming soon...</p>
    </div>
  `)}function pe(){A([{label:"Home",route:"home"},{label:"Flashcards"}]);const e=document.getElementById("content");if(!e)return;e.innerHTML=`
    <h1>Flashcards</h1>
  ...
  `;const s=e.querySelector(".flashcard");s&&s.addEventListener("click",()=>{s.classList.toggle("flipped")})}function fe(){var n;A([{label:"Home",route:"home"},{label:"Cheat Sheet"}]);const e=document.getElementById("content");if(!e)return;const s=((n=E.data)==null?void 0:n.cheatSheet)||"",t=me(s);e.innerHTML=`
...
`),t=[];let n=!1,a=[],i=!1,l=[],r=!1,v=1;function u(){if(a.length>0){const S=a.some(c=>c.includes("|---")),o=c=>c.includes("|---"),f=a.filter(c=>!o(c));if(f.length>0){let c='<table class="cheatsheet-table">';if(S&&f.length>1){const h=f[0].split("|").filter(p=>p.trim()).map(p=>`<th>${b(p.trim())}</th>`).join("");c+=`<thead><tr>${h}</tr></thead><tbody>`;for(let p=1;p<f.length;p++){const $=f[p].split("|").filter(T=>T.trim()).map(T=>`<td>${b(T.trim())}</td>`).join("");c+=`<tr>${$}</tr>`}c+="</tbody></table>"}else{for(const h of f){const p=h.split("|").filter($=>$.trim()).map($=>`<td>${b($.trim())}</td>`).join("");c+=`<tr>${p}</tr>`}c+="</table>"}t.push(c)}}a=[],n=!1}function d(){l.length>0&&(r?t.push(`<ol class="cheatsheet-list" start="${v}">${l.join("")}</ol>`):t.push(`<ul class="cheatsheet-list">${l.join("")}</ul>`)),l=[],i=!1,r=!1,v=1}for(const S of s){const o=S.trim();if(o===""){u(),d();continue}if(o.startsWith("|")&&o.endsWith("|")){n||(d(),n=!0),a.push(o);continue}if(o.startsWith("- ")||o.startsWith("* ")){u(),(!i||r)&&(d(),i=!0,r=!1),l.push(`<li class="cheatsheet-list-item">${b(o.slice(2))}</li>`);continue}const f=o.match(/^(\d+)\.\s+(.+)$/);if(f){u(),(!i||!r)&&(d(),i=!0,r=!0,v=parseInt(f[1],10)),l.push(`<li class="cheatsheet-list-item">${b(f[2])}</li>`);continue}if(o.startsWith(">")){u(),d();const c=o.slice(1).trim();if(c.includes("**Exam Alert")){const h=c.replace(/\*\*Exam Alert[^*]*\*\*/g,"");t.push(`<div class="callout callout-exam"><div class="callout-title">Exam Alert</div><p>${b(h)}</p></div>`)}else if(c.includes("**Memory Aid")){const h=c.replace(/\*\*Memory Aid[^*]*\*\*/g,"");t.push(`<div class="callout callout-memory"><div class="callout-title">Memory Aid</div><p>${b(h)}</p></div>`)}else if(c.includes("**Prior Test")){const h=c.replace(/\*\*Prior Test[^*]*\*\*/g,"");t.push(`<div class="callout callout-prior"><div class="callout-title">Prior Test</div><p>${b(h)}</p></div>`)}else if(c.includes("**PG Conflict")){const h=c.replace(/\*\*PG Conflict[^*]*\*\*/g,"");t.push(`<div class="callout callout-conflict"><div class="callout-title">PG Conflict</div><p>${b(h)}</p></div>`)}else if(c.includes("**See Also")){const h=c.replace(/\*\*See Also[^*]*\*\*/g,"");t.push(`<div class="callout callout-seealso"><div class="callout-title">See Also</div><p>${b(h)}</p></div>`)}else if(c.includes("**Sergeant Focus")){const h=c.replace(/\*\*Sergeant Focus[^*]*\*\*/g,"");t.push(`<div class="callout callout-sergeant"><div class="callout-title">Sergeant Focus</div><p>${b(h)}</p></div>`)}else if(c.includes("**NOTE:**")){const h=c.replace(/\*\*NOTE:\*\*/g,"");t.push(`<div class="callout callout-note"><div class="callout-title">Note</div><p>${b(h)}</p></div>`)}else c.startsWith("**Memory Aid")?t.push(`<div class="callout callout-memory"><div class="callout-title">Memory Aid</div><p>${b(c)}</p></div>`):t.push(`<blockquote class="cheatsheet-blockquote">${b(c)}</blockquote>`);continue}if(o==="---"||o==="***"||o==="___"){u(),d();continue}u(),d(),t.push(`<p class="cheatsheet-paragraph">${b(o)}</p>`)}return u(),d(),t.join("")}function b(e){if(!e)return"";let s=e;return s=s.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),s=s.replace(/\*([^*]+)\*/g,"<em>$1</em>"),s=s.replace(/`([^`]+)`/g,"<code>$1</code>"),s}function ye(){A([{label:"Home",route:"home"},{label:"Sergeant Focus"}]);const e=document.getElementById("content");if(!e||!E.data)return;const s=E.data.chapters.filter(a=>a.sergeantFocus&&a.sergeantFocus.length>0);e.innerHTML=`
  ...
  `}function Se(){A([{label:"Home",route:"home"},{label:"Weak Areas"}]);const e=document.getElementById("content");e&&(e.innerHTML=`
    <h1>Weak Areas</h1>
    <p>Review chapters where you scored lowest.</p>
    <div id="weak-areas-container">
      <p>Weak areas analysis coming soon...</p>
    </div>
  `)}const Ee={home:oe,"chapter/:id":R,quiz:ue,exam:he,flashcards:pe,cheatsheet:fe,sergeant:ye,weak:Se},E={currentRoute:"home",currentChapter:null,data:null};async function F(){if(console.log("Initializing NYPD Sergeant Study Guide..."),console.log("window.STUDY_DATA exists:",typeof window.STUDY_DATA<"u"),console.log("window.STUDY_DATA value:",window.STUDY_DATA),typeof window.STUDY_DATA<"u"&&window.STUDY_DATA&&window.STUDY_DATA.chapters)E.data=window.STUDY_DATA,console.log(`Loaded ${E.data.chapters.length} chapters from global`);else try{console.log("Fetching data.js...");const t=await(await fetch("/data.js")).text();console.log("data.js fetched, length:",t.length);const n="window.STUDY_DATA = ",a=t.indexOf(n);if(a===-1)throw new Error("Could not find window.STUDY_DATA prefix");let i=t.substring(a+n.length).trim(),l=0,r=!1,v=!1,u=-1;for(let d=0;d<i.length;d++){const S=i[d];if(v){v=!1;continue}if(S==="\\"){v=!0;continue}if(S==='"'&&!v){r=!r;continue}if(!r&&(S==="{"&&l++,S==="}"&&(l--,l===0))){u=d+1;break}}if(u===-1)throw new Error("Could not find matching closing brace");i=i.substring(0,u),console.log("JSON string length:",i.length),console.log("First 50 chars:",i.substring(0,50)),console.log("Last 50 chars:",i.substring(i.length-50)),E.data=JSON.parse(i),console.log(`Loaded ${E.data.chapters.length} chapters from fetch`)}catch(s){console.error("Failed to load study data:",s),document.getElementById("content").innerHTML=`<div class="error" style="padding:20px;color:red;">Failed to load study data: ${s}. Please refresh.</div>`;return}Y(),K(),se(E.data.chapters),ce(),G(Ee,(s,t)=>{E.currentRoute=s,E.currentChapter=(t==null?void 0:t.id)||null}),Te();const e=window.location.hash.slice(1)||"home";L(e),console.log("App initialized successfully")}function Te(){document.addEventListener("keydown",e=>{if((e.ctrlKey||e.metaKey)&&e.key==="k"){e.preventDefault();return}if(e.target.tagName!=="INPUT"&&/^[1-4]$/.test(e.key)){const s=new CustomEvent("quiz-keypress",{detail:{key:e.key}});document.dispatchEvent(s)}if(e.target.tagName!=="INPUT"&&(e.key==="n"||e.key==="p")){const s=new CustomEvent("nav-keypress",{detail:{key:e.key}});document.dispatchEvent(s)}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",F):F();
